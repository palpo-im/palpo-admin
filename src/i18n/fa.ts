...
import { PalpoTranslationMessages } from ".";

const fa: PalpoTranslationMessages = {
  ...farsiMessages,
  synapseadmin: {
    auth: {
      base_url: "آدرس سرور",
